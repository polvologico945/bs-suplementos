...
export default function AdminDashboard() {
  ...
  async function saveProduct(e: FormEvent) {
    ...
    const data = {
      category_id:
        typeof productForm.category_id === "string" &&
      ...
      description: sanitizeNullableText(
      ...
      price: sanitizeNonNegativeNumber(
        productForm.price,
        {
          nullable: true,
          max: 9999999,
      ...
      stock_status: [
        ...
        "low",
        "unavailable",
      ].includes(productForm.stock_status)
        ? productForm.stock_status
        : "available",

      sort_order: sanitizeInteger(
  ...
  async function saveSettings(e: FormEvent) {
    ...
    const safeSettings = {
      ...
      primary_color: sanitizeColor(
        settings.primary_color,
        "#16a34a",
      ),

      accent_color: sanitizeColor(
